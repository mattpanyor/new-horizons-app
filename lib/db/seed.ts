...
const users = [
  { username: "gm", password: "gm", group: "GM", role: "Gamemaster" },
...
async function seed() {
  ...
  for (const u of users) {
    ...
    await sql`
      INSERT INTO users (username, password, "group", role, character)
      VALUES (${u.username}, ${hash}, ${u.group}, ${u.role ?? null}, ${u.character ?? null})
